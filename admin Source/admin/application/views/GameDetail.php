      ...
      <div class="main-function">
        ...
        <div class="row">
          ...
          <div class="game-info">
            ...
            <div class="game-func">
              <p class="tag active-func" style="<?php if ($active == 1) { echo ""; } else { echo 'display:none;'; }?>"><a id="<?php echo $game_id;?>" game_type="<?php echo $game_type; ?>" class="deactive-game">DEACTIVE</a></p>
